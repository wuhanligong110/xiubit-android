...
/** 获取好友或关注列表 */
public class FollowListPage extends FollowerListFakeActivity implements OnClickListener,
		OnItemClickListener {
	...
	public void onCreate() {
		...
		llTitle.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,
				LayoutParams.WRAP_CONTENT));
		llPage.addView(llTitle);

		FrameLayout flPage = new FrameLayout(getContext());
		LinearLayout.LayoutParams lpFl = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,
				LayoutParams.WRAP_CONTENT);
		lpFl.weight = 1;
		...
		FrameLayout.LayoutParams lpLv = new FrameLayout.LayoutParams(LayoutParams.MATCH_PARENT,
		...
		FrameLayout.LayoutParams lpSd = new FrameLayout.LayoutParams(LayoutParams.MATCH_PARENT,
				LayoutParams.WRAP_CONTENT);
	...
	private static class FollowAdapter extends PullToRefreshListAdapter implements
