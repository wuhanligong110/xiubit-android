 ...
 * https://gold.xitu.io/entry/585b22c061ff4b006882e1e0
 *
 * @author qingyechen
 * @time 2016/12/26 0026 下午 6:26
 */
    ...
    public static class Builder {
        ...
        private void setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    // TODO: 2016/12/26 0026  获取上下文
                    mBuilder.setSpan(new ImageSpan(TopApp.getInstance(), bitmap), start, end, flag);
                    bitmap = null;
                    imageIsBitmap = false;
                    ...
                    //  2016/12/26 0026  获取上下文
                    mBuilder.setSpan(new ImageSpan(TopApp.getInstance(), uri), start, end, flag);
                    uri = null;
                    imageIsUri = false;
                } else {
                    //  2016/12/26 0026  获取上下文
                    mBuilder.setSpan(new ImageSpan(TopApp.getInstance(), resourceId), start, end, flag);
                    resourceId = 0;
