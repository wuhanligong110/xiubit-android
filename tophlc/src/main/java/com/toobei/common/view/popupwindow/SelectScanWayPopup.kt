...
class SelectScanWayPopup(val ctx: Activity, val listener: ClickListener) : PopupWindow(ctx), View.OnClickListener {
    companion object {
    ...
    private fun initView() {
        contentView = LayoutInflater.from(ctx).inflate(R.layout.layout_select_scan_way_popu_window, null)
