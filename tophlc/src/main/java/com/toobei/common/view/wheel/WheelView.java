...
import com.toobei.common.view.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	//private int[] SHADOWS_COLORS = new int[] { 0, 0, 0 };
	private int[] SHADOWS_COLORS = new int[] { 0xccffffff, 0x88ffffff, 0x00ffffff };
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(ContextCompat.getColor(getContext(),R.color.line_common));
		// 设置线宽
