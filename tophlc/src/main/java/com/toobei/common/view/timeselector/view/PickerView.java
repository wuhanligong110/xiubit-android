package com.toobei.common.view.timeselector.view;
...
public class PickerView extends View {
    ...
    private void init() {
        ...
        mPaint.setColor(ContextCompat.getColor(getContext(),R.color.text_black_common));
        //第二个paint
