...
//	private static final int DEFAULT_LINECOLOR = 0xaa888888;
	private static final int DEFAULT_LINECOLOR = 0xaadcdcdc;
	...
	public void setInputView(ImeDelBugFixedEditText inputView) {
		this.inputView = inputView;
	}

	private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
		TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.gridPasswordView,
				defStyleAttr, 0);

		textColor = ta.getColorStateList(R.styleable.gridPasswordView_textColor);
		if (textColor == null)
			textColor = ColorStateList.valueOf(ContextCompat.getColor(getContext(),
		...
		lineWidth = (int) ta.getDimension(R.styleable.gridPasswordView_lineWidth,
				Util.dp2px(getContext(), 1));
...
//		setOnClickListener(onClickListener);
	...
	public void setText(int indext, String str) {
		passwordArr[indext] = str;
		viewArr[indext].setText(passwordArr[indext]);
	}
