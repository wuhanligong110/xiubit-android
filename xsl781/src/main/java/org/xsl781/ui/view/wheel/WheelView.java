package org.xsl781.ui.view.wheel;
...
public class WheelView extends View {
	...
	public void setCenterDrawable(int drawable) {
		centerDrawable = ContextCompat.getDrawable(getContext(),drawable);
	}
	...
	public void setShadowsColors(int[] ShadowsColors) {
		this.SHADOWS_COLORS = ShadowsColors;
	}
	...
	private void initResourcesIfNecessary() {
		if (centerDrawable == null) {
			centerDrawable = ContextCompat.getDrawable(getContext(), R.drawable.xsl781_wheelview_scroll_picker_bar);
		}
		...
		if (backgroundDrawable != null) {
			...
			setBackgroundResource(R.drawable.xsl781_wheelview_bg);
		}
	}
