 ...
 * @time 2017/10/20
 */
class AvailableAddFeeCouponFragment : FragmentBase() {
//    var pageIndex = 1
    var productId =""
...
//        }, recyclerView)
        ...
        var emptyView = EmptyView(ctx).showEmpty(R.drawable.img_no_data_blank,"暂无可用加佣券")
    ...
    private fun getNetData() {
        RetrofitHelper.getInstance().retrofit.create(CouponApi::class.java)
                .availableProductAddfeeTicket(ParamesHelp()
