 ...
 * 机构info
 */
public class PlatformDetail extends BaseEntity implements Serializable{
    ...
    private String orgPlannerStrategy;                             //	    orgPlannerStrategy	理财攻略	string	理财师1.2.1版本
    ...
    //貅比特2.1.0新增
    private String shareDesc;                                        //分享描述	string	貅比特_APP_V2.1.0新增
    private String shareIcon;                                       //分享图标	string	貅比特_APP_V2.1.0新增
    private String shareLink;                                      //分享链接	string	貅比特_APP_V2.1.0新增
    private String shareTitle;                                     //	分享标题	string	貅比特_APP_V2.1.0新增
    private String orgFeeRatio;                                     //机构佣金率
    private String orgFeeRatioLimit;                                //佣金上限提示语
    private String orgFeeType;                                      //机构收费模式
    private String orgInvestdeadlineLimit;                          //cpa-投资期限限制
    ...
    //图片
    private List<OrgImageBean> orgEnvironmentList;        //	    orgEnvironmentList	机构环境图	array<object>	T呗/理财师2.0版本
    private List<OrgImageBean> orgHonorList;                    //	    orgHonorList	机构荣誉证书	array<object>	T呗/理财师2.0版本
    private List<OrgImageBean> orgPapersList;                  //	    orgPapersList	机构证书	array<object>	T呗/理财师2.0版本

    private List<OrgActivitysBean> orgActivitys;
    private List<TeamInfosBean> teamInfos;                          //         团队介绍	array<object>
    //V4.1.1
    private String cashInTime;   //提现到账
    private String contact;   //客服电话
    private String interestTime;   //	起息时间
    private String investOthers;   //	其他(投资)
    private List<OrgImageBean> orgCertificatesList;   //	其他(投资)
    private String productReleaseTime;   //		发标时间
    private String rechargeLimitDescription;   //		充值限制（描述）
    private String rechargeLimitLinkUrl;   //		充值限制（标题）
    private String rechargeLimitTitle;   //			充值限制（标题）
    private String withdrawalCharges;   //				提现费用

    //4.6.5
    public String orgProductUrlSkipBindType;//0-跳转前不需要绑卡 1-跳转前需要绑卡

    public List<OrgImageBean> getOrgEnvironmentList() {
        return orgEnvironmentList;
    }

    public void setOrgEnvironmentList(List<OrgImageBean> orgEnvironmentList) {
        this.orgEnvironmentList = orgEnvironmentList;
    }

    public List<OrgImageBean> getOrgHonorList() {
        return orgHonorList;
    }

    public void setOrgHonorList(List<OrgImageBean> orgHonorList) {
        this.orgHonorList = orgHonorList;
    }

    public List<OrgImageBean> getOrgPapersList() {
        return orgPapersList;
    }

    public void setOrgPapersList(List<OrgImageBean> orgPapersList) {
        this.orgPapersList = orgPapersList;
    }

    public List<OrgImageBean> getOrgCertificatesList() {
        return orgCertificatesList;
    }

    public void setOrgCertificatesList(List<OrgImageBean> orgCertificatesList) {
    ...
    public String getOrgInvestdeadlineLimit() {
        return orgInvestdeadlineLimit;
    }

    public void setOrgInvestdeadlineLimit(String orgInvestdeadlineLimit) {
    ...
    public static class OrgImageBean extends BaseEntity {
