...
public class InviteCustomHisDetail extends BaseEntity {

    private static final long serialVersionUID = -2117505967718384671L;
    ...
    private String investFlag;      //investFlag	是否投资	string 是否投资 0已投资，1未投资
