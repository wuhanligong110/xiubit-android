 ...
 *
 *
 * 改自compile 'com.jpardogo.materialtabstrip:library:1.1.0'
 */
public class MyPagerSlidingTabStrip extends HorizontalScrollView {

    public static final int DEF_VALUE_TAB_TEXT_ALPHA = 150;
    private static final int[] ANDROID_ATTRS = new int[]{android.R.attr.textColorPrimary, android.R.attr.padding, android.R.attr.paddingLeft, android.R.attr.paddingRight,};
    ...
    private int tabUnSelectedColor = Color.parseColor("#969696");
    ...
    public MyPagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        isTabTextAllCaps = a.getBoolean(R.styleable.PagerSlidingTabStrip_pstsTabTextAllCaps, false);//是否大小写？
        ...
        if (mTabTextColor == null) {
            mTabTextColor = createColorStateList(textPrimaryColor, textPrimaryColor, Color.argb(tabTextAlpha, Color.red(textPrimaryColor), Color.green(textPrimaryColor), Color.blue(textPrimaryColor)));
        }
    ...
    public void setViewPager(ViewPager pager) {
        ...
        if (pager.getAdapter() == null) {
            throw new IllegalStateException("ViewPager does not have investRecordAdapter instance.");
        }
                ...
                if (isTabTextAllCaps) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                            tab_title.setText(tab_title.getText().toString().toUpperCase(getResources().getConfiguration().getLocales().get(0)));
                        } else {
                        }
                    }
                }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mUnderlineHeight > 0) {
            ...
            canvas.drawRect(mPaddingLeft + 25, height - mUnderlineHeight, mTabsContainer.getWidth() + mPaddingRight - 25, height, mRectPaint);
        }
        ...
        if (mIndicatorHeight > 0) {
            ...
            Pair<Float, Float> lines = getIndicatorCoordinates();
            canvas.drawRect(lines.first + mPaddingLeft + 25, height - mIndicatorHeight, lines.second + mPaddingLeft - 25, height, mRectPaint);
        }
    }
    ...
    private void unSelect(View tab) {
        if (tab != null) {
            ...
            if (tab_title != null) {
                ...
                tab_title.setTextColor(tabUnSelectedColor);
    ...
    public void setTabUnSelectedColor(int color) {
