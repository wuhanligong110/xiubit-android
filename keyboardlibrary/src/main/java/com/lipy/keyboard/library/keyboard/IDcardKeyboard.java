 ...
 */
public class IDcardKeyboard extends BaseKeyboard {

    public IDcardKeyboard(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public IDcardKeyboard(Context context, KeyboardParams params, BaseKey.KeyListener
            keyListener) {
        super(context, params, new String[]{"1", "2", "3", "4", "5", "6", "7", "8", "9", "x","0"},
                keyListener);
    }
